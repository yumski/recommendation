...
The graph for movie bias is consistent with our findings in the movie distribution graph. Majority of the movies are rated very close to the average, which some exceptional movies receiving a high rating.
